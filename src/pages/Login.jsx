  ...
  return (
    ...
    <div className="w-full md:h-[90%] h-[92vh] md:flex md:flex-row flex flex-col items-center justify-center xl:gap-x-20 md:gap-x-10 lg:p-10 md:p-4 sm:p-10 px-5">
      <div className="xl:w-1/3 h-full md:w-[40%] hidden md:block lg:w-[40%]">
        <img src={img} alt="" className='w-full h-full object-center object-contain'/>
      </div>
      <div className="md:w-[50%] w-full xl:w-[40%] lg:w-[50%]  flex flex-col items-center bg-[#F3F4F6] rounded-xl py-7 px-8">
        <h1 className="text-[#11187] text-2xl">Log In</h1>
        <form className="w-full mt-4 space-y-4">

          <section>
            <label htmlFor="name">Official Email-Id</label>
          ...
          <button className="px-4 py-2 bg-[#0B056D] shadow-md shadow-[#344BFD] w-full rounded-md text-white">Login</button>
          <div className="flex items-center my-4 px-3">
            ...
            <Link to="/register">
            <button className="px-4 py-2 mt-3 border border-black w-full rounded-md text-black">
              New to Plixipy? Create an account!
            </button>
            </Link>
        </form>
      </div>
